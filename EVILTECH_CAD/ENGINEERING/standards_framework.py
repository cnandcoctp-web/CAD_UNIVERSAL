"""Industry standards access for engineering disciplines."""
...
class IndustryStandardsFramework:
    """Expose discipline-specific industry standards."""

    def __init__(self, registry: EngineeringRegistry) -> None:
        self.registry = registry

    def list_for_discipline(self, discipline: DisciplineType) -> list[str]:
        """Return standards associated with a discipline."""
        return list(self.registry.get(discipline).standards)